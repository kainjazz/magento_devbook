...
[Создание страницы в админке](http://devdocs.magento.com/guides/v2.2/ext-best-practices/extension-coding/example-module-adminpage.html)  
[Роутинг](http://devdocs.magento.com/guides/v2.2/extension-dev-guide/routing.html)  
[UI components](http://devdocs.magento.com/guides/v2.1/ui_comp_guide/bk-ui_comps.html)  
[Использование UI components](http://devdocs.magento.com/guides/v2.0/ui-components/ui_components_js.html)  
...
[Погружение в ценообразование Magento 2, убираем копейки после скидок](https://habrahabr.ru/post/336934)
